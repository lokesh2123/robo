...
ZONE_ID="Z04296232TPHCB0NK6KLW" # replace with your zone ID
DOMAIN_NAME="lokesh23.online" # replace with your domain name
R="\e[31m"
G="\e[32m"
Y="\e[33m"
N="\e[0m"
...
do
    ...
    if [ $ACTION == "create" ]; then
        if [ $INSTANCE_ID == "None" ]; then
            echo "Launching Instance: robo-$instance"
            INSTANCE_ID=$( aws ec2 run-instances \
            --image-id $AMI_ID \
            --instance-type t3.micro \
            --security-groups "robo-common" "robo-$instance" \
